...
use Drupal\tfa\Plugin\TfaValidation\TfaValidateCode;

/**
 * Class TfaEmailCodeSetup
 *
 * @TfaSetup(
 *   id = "tfa_email_send_setup",
 ...
 * )
 */
class TfaEmailCodeSetup extends TfaValidateCode implements TfaSetupInterface {
  ...
  public function getSetupForm(array $form, FormStateInterface $form_state) {
    ...
    $userData = $this->userData->get('tfa', $params['account']->id(), 'tfa_send_code');
  ...
  public function submitSetupForm(array $form, FormStateInterface $form_state) {
    ...
    $this->userData->set('tfa', $params['account']->id(), 'tfa_send_code', $userData);
